...
bool Adafruit_BNO055::write8(adafruit_bno055_reg_t reg, uint8_t value) {
	...
	transfer.slaveAddress = _address;
	transfer.direction = kI2C_Write;
	transfer.subaddress = (uint8_t) reg;
  ...
  transfer.flags = kI2C_TransferDefaultFlag;
	...
	i2c_master_transfer_t transfer = {
		...
		.subaddress = (uint8_t) reg, // TODO how to write to subaddress/reg
		.subaddressSize = sizeof(reg), // TODO is this right?!?!?
		.data = &value, // TODO fill with data. Type is uint8_t
